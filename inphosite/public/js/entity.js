...
function loadMore() {
  ...
  var thinkers = ['influenced_by', 'influenced', 'teachers', 'students', 'related', 'related_ideas'];
  var thinkersHeaders = ['Influenced By', 'Influenced', 'Teachers', 'Students', 'Related Thinkers', 'Related Terms'];
